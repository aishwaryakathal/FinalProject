    ...
    <div class="main-panel">
      ...
      <div class="container-fluid">
        <div class="navbar-wrapper">
          ...
          <a class="navbar-brand" href="#pablo">Send Email</a>
        </div>
      ...
      <div class="panel-body">
                      <form action="{{route('send_email')}}" method="POST" class="form-horizontal">
                          {{ csrf_field() }}


                          <div class="form-group">
                              <label class="control-label col-sm-2"  >Type Email Address:</label>
                              <div class="col-sm-10">
