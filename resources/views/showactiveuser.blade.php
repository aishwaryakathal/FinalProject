    ...
    <div class="main-panel">
      ...
      <div class="container-fluid">
        <div class="navbar-wrapper">
          ...
          <a class="navbar-brand" href="#pablo">Activate Users</a>
        </div>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="{{route('show_user_active') }}">You have {{$users}} new users </a>
      ...
      <tbody>
        @foreach($usersactive as $user)
          <tr>
              ...
              <td>{{$user->gender}}</td>
              <td>
             <a href="{{route('activate_user', $user->id)}}" class="view-modal btn btn-warning btn-sm" onclick="return confirm('Are you sure to activate user?')">Activate <i class="fa fa-check" aria-hidden="true"></i></a>
