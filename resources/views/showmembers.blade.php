    ...
    <div class="main-panel">
      ...
      <div class="container-fluid">
        <div class="navbar-wrapper">
          ...
          <a class="navbar-brand" href="#pablo">Membership Status</a>
        </div>
      ...
      <thead>
          ...
          <tr>
              ...
              <th class="text-left">Purchased Membership</th>
      ...
      <tbody>
        @foreach($users as $user)
          <tr>
            ...
            <td>
              <a href="{{ route('edit_membership', $user->id) }}" class="edit-modal btn btn-warning btn-sm">Edit <i class="fa fa-edit" aria-hidden="true"></i></a>
